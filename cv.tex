...
\item Designed and led implementation of alternative to extremely expensive 3rd party product for complex messaging processing.
\subitem{
...
\item Replaced legacy Nordea major risk engine and speed it up more than x10 times.
\subitem{
...
\textit{Achievements:}
\begin{itemize}
\item Developmed low latency price distribution system with zero GC.
\end{itemize}
